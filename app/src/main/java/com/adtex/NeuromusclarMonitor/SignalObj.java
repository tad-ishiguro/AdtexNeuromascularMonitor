...
//			m_ma.m_UsbCom.Reconnect();   //adtex
		...
		str = "Time TOF T4% PTC T1 T1%:" + m_line;
...
//        canvas.drawText(str, x1, y2 , m_Text);
	...
	public void DrawValueMeasTime(Canvas canvas, int y4)
	{
		...
		str3 = str + " / " + str2;
		canvas.drawText(str3, m_nCharSize * 0, y4 - 2, m_frPaint);
		str = "";
...
//		UsbManager mUsbManager = (UsbManager)mContext.getSystemService(Context.USB_SERVICE);
		...
		m_line = String.format("%.1f",  m_fTime[2][m_nNoOfData[2]]);
		int str = (int) m_fWork[5];
		m_line = m_line + " " + String.format("%d",  str);
