...
//	int iVid = 0x067b;	// Vendor ID of 0x067B / 0x2303: Prolific PL2303
//	int iPid = 0x2303;	// Defualt:0x067B / 0x2303: Prolific PL2303
	int iVid = 0x0584;	// Vendor ID of RATOC
	int iPid = 0xb020;	// Defualt:REX-USB60F
//	int iVid = 0x0403;	// 0x0403,0x6001 FTDI dongru
//	int iPid = 0x6001;	// 0x0403,0x6001 FTDI dongru
    ...
    public void InitObj(Context context) {        //�Ăяo���Ƃ��� m_UsbCom.InitObj(this);
		...
		if (ftdid2xx != null) {
			...
			if(!ftdid2xx.setVIDPID(0x403, 0x6001))		// Set VID/PID of target USB device bluetooth dongru
				Log.i("ftd2xx-java","setVIDPID Error");
			if(!ftdid2xx.setVIDPID(0x0678, 0x2303))		// Set VID/PID of target USB device 0x1a86 / 0x?523: Qinheng CH34xru
				Log.i("ftd2xx-java","setVIDPID Error");

//			String str;
//			int[][] aaa = ftdid2xx.getVIDPID();

//			str = String.valueOf(aaa[1][21]);
			/*
			aaa[0][~]	: VID
			aaa[1][~]	: PID
			       ~	: 種類
...
//	    	Toast.makeText(m_ma, str, Toast.LENGTH_SHORT).show();
...
//		Toast.makeText(m_ma, "yyyyyyyyyyyyyyyyyyyyyyyyx", Toast.LENGTH_SHORT).show();
